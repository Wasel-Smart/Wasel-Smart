 ...
 * Terms of Service
 * 
 * Legal terms and conditions for using Wassel platform.
 */
      ...
      <Card>
        <CardContent className="pt-6 prose dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              By accessing and using Wassel ("the Platform", "we", "us", or "our"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, you should not use this platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Wassel provides a technology platform that connects passengers with independent transportation providers (drivers) and delivery services. We do not provide transportation or delivery services directly, and we are not a transportation carrier.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Wassel Wallet (prepaid balance)</li>
              <li>Corporate account billing</li>
            </ul>
            <h3 className="text-xl font-semibold mt-4 mb-2">4.3 Service Fees</h3>
            <p>
              Wassel charges a service fee (typically 20%) on each transaction to maintain and improve the platform. This fee is included in the quoted fare.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Drivers earn 80% of the trip fare (after service fee). Tips are paid 100% to drivers. Payouts are processed weekly via bank transfer or Wassel Wallet.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Wassel acts as a technology platform connecting users with independent service providers. We are not liable for the actions, conduct, or services provided by drivers or passengers.
            </p>
            <h3 className="text-xl font-semibold mt-4 mb-2">8.2 Insurance Coverage</h3>
            <p>
              All drivers must maintain valid auto insurance. Wassel provides supplemental insurance coverage during active trips as required by local regulations.
            </p>
            <h3 className="text-xl font-semibold mt-4 mb-2">8.3 Lost Items</h3>
            <p>
              While we facilitate lost item recovery, Wassel is not responsible for personal belongings left in vehicles. Users should use the in-app lost item report feature.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              For disputes that cannot be resolved through our dispute center, parties agree to binding arbitration under the laws of the United Arab Emirates.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Your use of Wassel is also governed by our Privacy Policy. We collect and use data as described in our Privacy Policy to provide and improve our services.
            </p>
          ...
          <section className="mb-8">
            ...
            <p>
              All content, trademarks, and intellectual property on the Wassel platform are owned by Wassel or licensed to us. Users may not copy, modify, or distribute our content without permission.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Either party may terminate this agreement at any time. Wassel reserves the right to immediately suspend or terminate accounts for violations of these terms or applicable laws.
            </p>
          </section>
          ...
          <section className="mb-8 p-6 bg-muted rounded-lg">
            ...
            <p>
              BY USING WASSEL, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THESE TERMS OF SERVICE.
            </p>
          </section>
        </CardContent>
      </Card>
