 ...
 * Privacy Policy
 * 
 * Data privacy and protection policy for Wassel platform.
 */
      ...
      <Card>
        <CardContent className="pt-6 prose dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Wassel ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our ride-sharing and delivery platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              We may disclose information if required by law, court order, or to protect rights, safety, and property of Wassel and our users.
            </p>
          ...
          <section className="mb-8">
            ...
            <p>
              You can disable location services in device settings, but this will prevent you from using Wassel services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Wassel is not intended for users under 18. We do not knowingly collect information from children. If we become aware of such collection, we will delete it immediately.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-none pl-6 space-y-2 mt-4">
              <li>Email: privacy@wassel.com</li>
              <li>Data Protection Officer: dpo@wassel.com</li>
