...
export const INTEGRATION_CONFIG = {
  ...
  googleMaps: {
    ...
    enabled: !!(import.meta as any).env.VITE_GOOGLE_MAPS_API_KEY,
  },
  
  // Stripe Payments
  stripe: {
    publishableKey: (import.meta as any).env.VITE_STRIPE_PUBLISHABLE_KEY || '',
    enabled: !!(import.meta as any).env.VITE_STRIPE_PUBLISHABLE_KEY,
  },
  
  // Twilio (SMS/Voice)
  twilio: {
    accountSid: (import.meta as any).env.VITE_TWILIO_ACCOUNT_SID || '',
    enabled: !!(import.meta as any).env.VITE_TWILIO_ACCOUNT_SID,
  },
  
  // SendGrid (Email)
  sendgrid: {
    apiKey: (import.meta as any).env.VITE_SENDGRID_API_KEY || '',
    enabled: !!(import.meta as any).env.VITE_SENDGRID_API_KEY,
  },
  ...
  firebase: {
    ...
    enabled: !!(import.meta as any).env.VITE_FIREBASE_API_KEY,
  },
  
  // Identity Verification (Jumio)
  jumio: {
    apiKey: (import.meta as any).env.VITE_JUMIO_API_KEY || '',
    apiSecret: (import.meta as any).env.VITE_JUMIO_API_SECRET || '',
    enabled: !!(import.meta as any).env.VITE_JUMIO_API_KEY,
  },
  
  // Analytics
  mixpanel: {
    token: (import.meta as any).env.VITE_MIXPANEL_TOKEN || '',
    enabled: !!(import.meta as any).env.VITE_MIXPANEL_TOKEN,
  },
